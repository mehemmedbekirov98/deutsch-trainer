...
const LANG_NAMES = { ru: "Russian", az: "Azerbaijani (Latin script)" };
...
export function profileBlock(profile = {}) {
  ...
  const mode = profile.mode === "german"
    ? `They have asked to talk in GERMAN right now. Speak German (lang = "de") and correct real mistakes. If they switch back to ${LANG_NAMES[ui]}, answer that in ${LANG_NAMES[ui]} and set mode = "chat".`
