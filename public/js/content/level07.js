export default {
  ...
  vocab: [
    { de: "der Supermarkt", ru: "супермаркет", plural: "die Supermärkte", example: "Ali kauft im Supermarkt ein.", exampleRu: "Али делает покупки в супермаркете." },
    ...
    { de: "die Jacke", ru: "куртка", plural: "die Jacken", example: "Ali kauft eine Jacke.", exampleRu: "Али покупает куртку." },
  ...
  grammar: [
    {
      ...
      examples: [
        { de: "Ali kauft zwei Hemden.", ru: "Али покупает две рубашки." },
    ...
    },
    {
      ...
      examples: [
        ...
        { de: "Ali probiert diesen Mantel an.", ru: "Али примеряет это пальто." },
    ...
    },
    {
      ...
      examples: [
        ...
        { de: "Gefällt dir das T-Shirt, Ali?", ru: "Тебе нравится футболка, Али?" },
  ...
  exercises: [
    ...
    { type: "fill", sentence: "Ali kauft zwei ___.", answers: ["Hosen"], options: ["Hosen", "Hose", "Hosens"], ru: "Али покупает двое брюк.", explain: "die Hose → die Hosen: слова на -e получают -n." },
    { type: "match", pairs: [
    ...
    { type: "fill", sentence: "Ali kauft ___ Mantel.", answers: ["den"], options: ["den", "der", "das"], ru: "Али покупает пальто.", explain: "der Mantel → Akkusativ: den Mantel." },
    ...
    { type: "fill", sentence: "Gefällt ___ die Jacke, Ali?", answers: ["dir"], options: ["dir", "du", "mir"], ru: "Тебе нравится куртка, Али?", explain: "Вопрос к Али → dir (тебе)." },
  ...
  dialogue: {
    ...
    lines: [
      ...
      { speaker: "Ali", de: "Guten Tag. Ich suche eine Jacke.", ru: "Добрый день. Я ищу куртку." },
      { speaker: "Verkäuferin", de: "Welche Größe haben Sie?", ru: "Какой у вас размер?" },
      { speaker: "Ali", de: "Größe M. Und ich möchte sie in Blau.", ru: "Размер M. И я хочу её синего цвета." },
      { speaker: "Verkäuferin", de: "Hier ist eine Jacke in Blau. Gefällt sie Ihnen?", ru: "Вот синяя куртка. Она вам нравится?" },
      { speaker: "Ali", de: "Ja, sie gefällt mir. Ich probiere sie an.", ru: "Да, она мне нравится. Я её примерю." },
      { speaker: "Verkäuferin", de: "Und? Passt die Jacke?", ru: "Ну как? Куртка подходит?" },
      { speaker: "Ali", de: "Ja, sie passt gut. Wie viel kostet sie?", ru: "Да, она хорошо сидит. Сколько она стоит?" },
      { speaker: "Verkäuferin", de: "Sie kostet neunundvierzig Euro neunzig.", ru: "Она стоит 49 евро 90 центов." },
      { speaker: "Ali", de: "Gut, ich nehme die Jacke. Wo ist die Kasse?", ru: "Хорошо, я беру куртку. Где касса?" },
      { speaker: "Verkäuferin", de: "Die Kasse ist dort vorne. Möchten Sie eine Tüte?", ru: "Касса там впереди. Хотите пакет?" },
      { speaker: "Ali", de: "Ja, bitte. Danke schön!", ru: "Да, пожалуйста. Большое спасибо!" }
    ]
  },
  ...
  speaking: {
    ...
    tutorBrief: "Mia is helping Ali shop for a pullover in a clothes shop. Ask what he is looking for, which colour he likes, his size, whether the pullover fits and whether he likes it, and whether he takes it at thirty euros. Target structures: ich suche einen/eine/ein…, Größe M, die Farbe … gefällt mir, er passt (nicht), ich nehme den Pullover, das ist zu teuer, wie viel kostet…, plural forms. Keep to A1 vocabulary of shopping and clothes; no modal verbs, no Imperativ, no past tense.",
    phrases: [
    ...
    script: [
      { say: "Hallo Ali! Wir sind im Geschäft. Was suchst du heute?", sayRu: "Привет, Али! Мы в магазине. Что ты сегодня ищешь?", hint: "Ich suche einen Pullover.", expect: ["suche", "pullover", "hose", "hemd", "jacke", "mantel", "schuhe", "shirt", "kleid"] },
      ...
      { say: "Prima, Ali! Die Kasse ist dort vorne. Das war sehr gut. Tschüss!", sayRu: "Отлично, Али! Касса там впереди. Это было очень хорошо. Пока!", hint: "Danke, Mia! Tschüss!", expect: ["tschüss", "tschuss", "danke", "bis", "ciao"] }
    ]
  },
