...
/**
 * Сколько строк уже в словаре.
 *
 * Нужно тому, кто строит по словарю свой указатель и кэширует его. Словари теперь приезжают
 * по мере надобности, и указатель, построенный на половине из них, остался бы половинчатым навсегда.
 */
